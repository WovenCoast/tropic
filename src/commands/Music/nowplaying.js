...
module.exports = class extends Command {
    ...
    async run(msg) {
        ...
        return msg.channel.send(`:arrow_forward: Now playing: **${this.parse(serverQueue.player.state.position)} / ${this.parse(serverQueue.songs[0].info.length)}** of **${serverQueue.songs[0].info.title}** requested by *${serverQueue.songs[0].info.author}*`);
    }
