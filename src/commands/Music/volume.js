...
module.exports = class extends Command {
    ...
    async run(msg, [volume]) {
        ...
        if (!volume) {
            ...
            if (!utils.guildIsPremium(this.client, msg.guild.id) && volume > this.normalUserLimit) return msg.channel.send(`:x: This guild needs Tropic Premium to set the volume higher than ${this.normalUserLimit}%!`)
