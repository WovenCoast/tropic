...
module.exports = class extends Monitor {
    ...
    async run(msg) {
        ...
        if (await exec(`git pull`, { timeout: 'timeout' in msg.flags ? Number(msg.flags.timeout) : 60000 })
            .catch(error => ({ stdout: null, stderr: error })).stdout === "Already up-to-date.") return;
